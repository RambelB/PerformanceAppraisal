...
//        => optionsBuilder.UseNpgsql("Host=localhost:8080;Database=PerformanceAppraisal;Username=postgres;Password=new_password");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<IndikatorUtamaKerja>(entity =>
        {
            ...
            entity.Property(e => e.Target).HasColumnName("target");
            entity.Property(e => e.TingkatUnjukKerja).HasColumnName("tingkatUnjukKerja");
            entity.Property(e => e.UoM).HasColumnType("character varying");
            entity.Property(e => e.UpdatedAt)
                .HasColumnType("timestamp without time zone")
                .HasColumnName("updated_at");
            entity.Property(e => e.UpdatedBy).HasColumnName("updated_by");
        ...
        modelBuilder.Entity<PerubahanNilai>(entity =>
        {
            ...
            entity.Property(e => e.CreatedAt)
                ...
                .HasColumnName("created_at");
            entity.Property(e => e.CreatedBy).HasColumnName("created_by");
            entity.Property(e => e.FireIncident).HasColumnName("fireIncident");
            ...
            entity.Property(e => e.SuratPeringatan).HasColumnName("suratPeringatan");
            entity.Property(e => e.UpdatedAt)
                .HasColumnType("timestamp without time zone")
                .HasColumnName("updated_at");
            entity.Property(e => e.UpdatedBy).HasColumnName("updated_by");
